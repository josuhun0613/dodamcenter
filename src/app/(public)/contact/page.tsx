...
export const metadata: Metadata = {
  title: '상담 문의',
  description: '다온상담센터 상담 문의. 전문 상담사가 정성껏 답변드립니다.',
};
              ...
              <AnimatedSection direction="left">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-sage-50 text-accent flex items-center justify-center shrink-0">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-sage-300">주말·공휴일 휴무</p>
                    </div>
                  </div>
