...
const sampleReviews = [
  ...
  },
  {
    ...
    content: '비용 때문에 상담 계속 미루다가 청년 응원 패키지로 시작했어요! 😆 프로그램이 체계적이라 그냥 상담만 받는 것보다 효과가 좋았고 지금은 일상이 훨씬 안정적이에요~ 이런 패키지가 있는 줄 진작 알았으면 좋았을 텐데ㅠ 부담 없이 전문 상담 받을 수 있어서 정말 감사했습니다. 주변 친구들한테도 추천했어요! 경제적으로 부담돼서 망설이는 분들 꼭 알아보세요 👍',
    rating: 5,
